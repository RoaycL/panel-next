...
import (
	...
	"os"
	"panel-next/global"
	"panel-next/initialize/cUserToken"
	"panel-next/initialize/config"
	"panel-next/initialize/database"
	"panel-next/initialize/lang"
	"panel-next/initialize/other"
	"panel-next/initialize/redis"
	"panel-next/initialize/runlog"
	"panel-next/initialize/systemSettingCache"
	"panel-next/initialize/userToken"
...
func Logo() {
	...
	fmt.Println("Welcome to the Panel Next.")
	fmt.Println("Project address:", "https://github.com/RoaycL/panel-next")
