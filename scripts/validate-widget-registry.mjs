...
for (const type of ['core.clock', 'core.date', 'core.search', 'core.weather', 'core.trending'])
...
assert.match(home, /<WidgetHost :instance="trendingWidget"/)
...
console.log('Validated widget registry, migrations, built-in clock/date/search/weather/trending, and async host')
