...
for (const type of ['core.clock', 'core.date', 'core.search', 'core.weather'])
...
console.log('Validated widget registry, migrations, built-in clock/date/search/weather, and async host')
